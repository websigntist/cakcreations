...
$l = 4;
$l += count(explode('/', str_replace('/assets/admin/vendors/tinymce/plugins/filemanager/dialog.php', '', $_SERVER['SCRIPT_NAME'])));
$dir_tail = intval(count(explode('/', $_COOKIE['c_path']))-$l);
$dir_tail = ($dir_tail <= 0 ? 2 : $dir_tail);
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => str_repeat('../', $dir_tail) . 'assets/frontend/media/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    //*********************
    'ext_blacklist'							  => ['exe','bat'],//false,//['exe','bat','jpg'],

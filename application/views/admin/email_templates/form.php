                    ...
                    <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-sm-12 col-md-2 col-lg-2 col-form-label">Email Title: <span class="required">*</span></label>
                            ...
                            <div class="form-group row">
                                <label for="subject" class="col-sm-12 col-md-2 col-lg-2 col-form-label">subject: <span class="required">*</span></label>
                                <div class="col-sm-12 col-md-10 col-lg-10">
                                    <input name="subject" type="text" value="<?php echo set_value('subject',$row->subject); ?>" class="form-control" placeholder="Enter subject" id="subject">
                                </div>
                            </div>
                            <div class="kt-separator kt-separator--border-dashed kt-separator--space-md"></div>
                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group topimg">
                                ...
                                <div class="mt-3 fImg">
                                    ...
                                    if ($row->image != '') {
                                        if ($row->id > 0) {
                                            $_image = 'images/email_templates/'.$row->image;
                                        } else {
                                            $_image = 'images/media/noimg.png';
                                        }
                      ...
                      <div class="kt-portlet__head">
                         <div class="kt-portlet__head-label">
                            <div class="kt-portlet__head-label">
                               ...
                               <h3 class="kt-portlet__head-title"> available shortcodes </h3>
                            </div>
                         </div>
                          <?php echo collapse_tool(); ?>
                      </div>
                      <div class="kt-portlet__body">
                         <div class="kt-portlet__content email_shortcodes">
                            <ul>
                               <li><pre>[logo]</pre></li>
                               <li><pre>[full_name]</pre></li>
                               <li><pre>[site_title]</pre></li>
                               <li><pre>[password_reset_link]</pre></li>
                            </ul>
                         </div>
                      </div>
                   </div>

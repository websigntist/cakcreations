...
$module = str_replace('_', ' ', 'email_templates');
$module_name_full = 'email_templates';
$module_name = $module;
$hide_col = ['id', 'sn'];
?>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'title';
                                                   echo '<td width="200" class="text-left">' . $row->title . '</td>';
                                                   break;
                                               case 'subject';
                                                   echo '<td width="200" class="text-left">' . $row->subject . '</td>';
                                                   break;
                                               case 'message';
                                                   echo '<td>' . substr(strip_tags($row->message),0,100) . '</td>';
                                                   break;
                                               case 'status';

   ...
   <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
      <div class="kt-aside__brand-logo">
         <a href="<?php echo base_url() ?>" target="_blank">
            <!--<h5 style="color: white"><?php /*echo get_option('admin_title'); */?></h5>-->
            <img src="<?php echo _img(asset_url('images/options/'.get_option('admin_logo')),60); ?>" alt="logo">
         </a>
      </div>
         ...
         <ul class="kt-menu__nav ">
             ...
             $_M->parent_li_start = '<li class="kt-menu__item {active_class}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                                    <a  href="{href}" class="kt-menu__link kt-menu__toggle">
                                                        <span class="kt-menu__link-text">{icon} {title}</span>
                                                        {has_child}
                                                    </a>';
             $_M->parent_li_end = '</li>';
             ...
             $_M->child_li_start = '<li class="kt-menu__item  kt-menu__item--submenu {active_class}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                    <a  href="{href}" class="kt-menu__link kt-menu__toggle ">
                                        <span class="kt-menu__link"><span class="kt-menu__link-text">{icon} {title}</span></span>
                                    </a>';
               ...
               <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                  <ul class="kt-menu__subnav">
                     <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true">
                        <span class="kt-menu__link"><span class="kt-menu__link-text">User Management</span></span>
                     </li>
                     <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                        <a href="<?php echo base_url('admin/users/view'); ?>" class="kt-menu__link kt-menu__toggle">
                           <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i>
                           <span class="kt-menu__link-text">Users</span>
                        </a>
                     </li>
                     <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                        <a href="<?php echo base_url('admin/user_type/view'); ?>" class="kt-menu__link kt-menu__toggle">
                           <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i>
                           <span class="kt-menu__link-text">Users Role</span>
                        </a>
                     </li>
                     <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                        <a href="<?php echo base_url('admin/modules/view'); ?>" class="kt-menu__link kt-menu__toggle">
                           <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i>
                           <span class="kt-menu__link-text">Add Module</span>
                        </a>
                     </li>
        ...
        <path d="M5.5,13 L9.5,13 C10.3284271,13 11,13.6715729 11,14.5 L11,18.5 C11,19.3284271 10.3284271,20 9.5,20 L5.5,20 C4.67157288,20 4,19.3284271 4,18.5 L4,14.5 C4,13.6715729 4.67157288,13 5.5,13 Z M14.5,4 L18.5,4 C19.3284271,4 20,4.67157288 20,5.5 L20,9.5 C20,10.3284271 19.3284271,11 18.5,11 L14.5,11 C13.6715729,11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z"
              id="Combined-Shape" fill="#000000" opacity="0.3"/>
               ...
               <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                  <ul class="kt-menu__subnav">
                     <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true">
                        <span class="kt-menu__link"><span class="kt-menu__link-text">CMS Management</span></span>
                     </li>
                     <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                        <a href="page_form.php" class="kt-menu__link kt-menu__toggle">
                           <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i>
                           <span class="kt-menu__link-text">Pages</span>
                        </a>
                     </li>
                     <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                        <a href="<?php echo base_url('admin/static_block/view'); ?>" class="kt-menu__link kt-menu__toggle">
                           <i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i>
                           <span class="kt-menu__link-text">Static Blocks</span>
                        </a>
                     </li>
                  </ul>
               </div>
            ...
            <li class="kt-menu__item" aria-haspopup="true">
               <a href="<?php echo $site_url; ?>/slider_form.php" class="kt-menu__link ">
                <span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <polygon id="Bound" points="0 0 24 0 24 24 0 24"/>
                  ...
                  <span class="kt-menu__link-text">Slider</span></a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true">
               <a href="<?php echo $site_url; ?>/banner_form.php" class="kt-menu__link ">
                <span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <polygon id="Bound" points="0 0 24 0 24 24 0 24"/>
                  ...
                  <span class="kt-menu__link-text">Banners</span></a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true">
               <a href="<?php echo $site_url; ?>/setting.php" class="kt-menu__link ">
                <span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <polygon id="Bound" points="0 0 24 0 24 24 0 24"/>
            ...
            <li class="kt-menu__item" aria-haspopup="true">
               <a href="<?php echo $site_url; ?>/images_gallery_form.php" class="kt-menu__link ">
                <span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <polygon id="Bound" points="0 0 24 0 24 24 0 24"/>
                  ...
                  <span class="kt-menu__link-text">Images Gallery</span></a>
            </li>

...
$hide_col = ['id', 'sn','exchange_rate','order_currency','coupon_id','shop_name','unit_price','order_no','order_id','single_id','shop_id'];
?>
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
               ...
               <div class="kt-subheader__toolbar">
                    <div class="btn-group">
                       <?php echo _button('Back','admin/seller_orders/full_order/'.$rows[0]->shop_id,'danger'); ?>
                       <?php echo export(null, 'admin/seller_orders/export_csv3/?o='.$rows[0]->order_id.'&s='.$rows[0]->shop_id) ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="row">
                <div class="col-lg-12">
                   ...
                   <form action="<?php echo site_url('admin/seller_orders/s_status_updated'); ?>" class="deleteAll" method="get">
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title"> <?php echo $rows[0]->shop_name .' - Order #'.$rows[0]->order_no; ?></h3>
                                </div>
                            </div>
                       ...
                       <div class="kt-portlet__body">
                          ...
                          <div class="table-responsive dtlabel">
                             ...
                             <table class="table table-bordered table-hover table-striped icon-color export_table">
                                ...
                                <?php
                                $s = 1;
                                $seller_status = get_enum_values('order_detail','seller_status');
                                foreach ($rows as $row) {
                                    ?>
                                   <tr class="<?php echo ($row->new_order == 1 ? 'new_order' : ''); ?>">
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'product_name';
                                                   echo '<td width="150" class="text-left">' . $row->product_name . '</td>';
                                                   break;
                                               case 'total_amount';
                                                  ...
                                                  <div class="btn-group stsbtn">
                                                      ...
                                                      <div class="dropdown-menu">
                                                         ...
                                                         foreach ($seller_status as $s_status) {
                                                           ...
                                                           echo '<a class="dropdown-item" href="'.site_url('admin/seller_orders/s_status_updated/'.$s_status.'/'.$row->single_id).'">'.$s_status.'</a>';
                                                         }
                                                         ?>
                                                      </div>
                                                    </div>

...
$hide_col = ['id', 'sn','p_id','referral_code'];
?>
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        <!-- begin:: breadcrumb -->
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('Referral', $module_name.LIST_TEXT); ?>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'referral_count';
                                                   echo '<td width="150">' . $row->referral_count . '</td>';
                                                   break;
                                               case 'product_referral_link';
                                                   echo '<td class="text-left">' . site_url('product/'.$row->product_referral_link.'-'.$row->p_id.'/?referral='.$row->referral_code). '</td>';
                                                   break;
                                               default:
                                                   echo '<td>' . $value . '</td>';
                                           }

    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('CMS Management', $module_name.LIST_TEXT); ?>
                                ...
                                <tr>
                                   <th>&nbsp;</th>
                                    ...
                                    foreach ($rows[0] as $col => $value) {
                                        ...
                                        switch ($col) {
                                            case 'parent';
                                                echo '<th><input type="text" name="search[parent]" value="' . $_GET['search']['parent'] . '" class="form-control" placeholder="Search..."/></th>';
                                                break;
                                            default:
                                   ...
                                   <tr id="<?php echo $row->id; ?>">
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'page_title';
                                                  echo '<td class="text-left">' . $row->page_title . '</td>';
                                                  break;
                                              case 'friendly_url';
                                                  echo '<td class="text-left">' . $row->friendly_url . '</td>';
                                                  break;case 'status';
                                                   echo '<td>' . page_status($row->status) . '</td>';
                                                   break;
                                               case 'created';
                                      ...
                                      <td>
                                          ...
                                          <?php echo _status_p('admin/' . $module_name . '/status/' . $row->id . '?status=' . $row->status, $row->status); ?>

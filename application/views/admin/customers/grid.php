...
$hide_col = ['id', 'sn','user_type','created','photo','shop_name'];
?>
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        <!-- begin:: breadcrumb -->
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('Customers', $module_name.LIST_TEXT); ?>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           if ($row->photo != '') {
                                               $photo = fancyImg_round('images/users/' . $row->photo, 50, 50, $row->photo, null);
                                           } else {
                                               $photo = noImg();
                                           }
                                           switch ($col) {
                                               case 'customer_name';
                                                   echo '<td width="150" class="text-left">' . $row->customer_name . '</td>';
                                                   break;
                                               case 'cust_type';
                                                   echo '<td width="100">' . $row->cust_type . '</td>';
                                                   break;
                                               case 'shop_name';
                                                   echo '<td width="180" class="text-left">' . $row->shop_name . '</td>';
                                                   break;
                                               case 'photo';
                                                   echo '<td>' . $photo . '</td>';
                                                   break;

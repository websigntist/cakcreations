                    ...
                    <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-2 offset-1 col-form-label text-right">Title:
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-2 offset-1 col-form-label text-right">Heading:</label>
                                <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-2 offset-1 col-form-label text-right">Sub Heading:</label>
                                <div class="col-6">
                                    <input name="sub_heading" type="text" value="<?php echo set_value('sub_heading', $row->sub_heading); ?>" class="form-control" placeholder="Enter sub heading" id="title">
                                </div>
                            </div>
                            <div class="kt-separator kt-separator--border-dashed kt-separator--space-md"></div>

                            <div class="form-group row">
                                <label for="link" class="col-2 offset-1 col-form-label text-right">Link:</label>
                                <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label for="link" class="col-2 offset-1 col-form-label text-right">button text:</label>
                                <div class="col-6">
                            ...
                            <div class="form-group topimg">
                                ...
                                <div class="mt-3 fImg">
                                    ...
                                    if ($row->image != '') {
                                        ...
                                        echo fancyImg($_image, 225, 125,$row->image,null);

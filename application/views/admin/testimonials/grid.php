    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('Customer Testimonials', $module_name.LIST_TEXT); ?>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           if ($row->image != '') {
                                               $image = fancyImg_round('images/'.$module_name.'/' . $row->image, 50, 50, $row->image, null);
                                           } else {
                                               $image = noImg();
                                           }
                                           ...
                                           switch ($col) {
                                               ...
                                               case 'status';
                                                   ...
                                                   break;
                                               case 'message';
                                                   echo '<td class="text-left">' . word_limiter($row->message,15) . '</td>';
                                                   break;
                                               case 'created';

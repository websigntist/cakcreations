...
$module = str_replace('_', ' ', 'blog_tags');
$module_name_full = 'blog_tags';
$module_name = $module;
$hide_col = ['id', 'sn'];
?>
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('Blogs', $module_name.LIST_TEXT); ?>
               <div class="kt-subheader__toolbar">
                  <div class="btn-group">
                      <?php echo add_new(null, 'admin/tags/form'); ?>
                      <?php echo delete_all($module_name_full); ?>
                      <?php echo export(null, 'admin/tags/export_csv'); ?>
                      <?php echo import(null, 'admin/tags/import_csv'); ?>
                  </div>
               </div>
            </div>
        </div>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'tags';
                                                   echo '<td>' . detail_input('tags',$row->id,$row->tags,'tags/AJAX/tags/','tags') . '</td>';
                                                   break;
                                               case 'status';
                                                   echo '<td>' . data_status($row->status) . '</td>';
                                                   break;
                                               case 'ordering';
                                                   echo '<td>' . ordering_input('tags/AJAX/ordering/',$row->id,$row->ordering) . '</td>';
                                                   break;
                                               default:
                                                   echo '<td>' . $value . '</td>';
                                           }
                                       ...
                                       <?php } ?>
                                      <td>
                                          <?php echo _edit('admin/tags/form/' . $row->id); ?>
                                          <?php echo _delete('admin/tags/delete/' . $row->id); ?>
                                          <?php echo _status('admin/tags/status/' . $row->id . '?status=' . $row->status, $row->status); ?>
                                      </td>
                                   </tr>
                                    <?php $s++; } ?>
                                </tbody>

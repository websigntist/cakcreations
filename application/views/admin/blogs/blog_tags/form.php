...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
   <form action="<?php echo admin_url('tags/add'); ?>" enctype="multipart/form-data" method="post" id="<? echo $module_nameFull?>">
        <!-- begin:: breadcrumb -->
         <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-container  kt-container--fluid ">
                    <?php echo breadcrum('Blogs', substr($module_name, 0, -1) . ' Form', ($row->id > 0 ? 'Update Form' : 'Add New')); ?>
                    ...
                    <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                <label for="tags" class="col-sm-12 col-md-3 col-lg-3 col-form-label">Enter Tag name: <span class="required">*</span></label>
                                <div class="col array-repeater">

                                   <div class="form-group-last row repeater_cls">
                                      <div data-repeater-list="color" class="col-sm-12 col-md-10 col-lg-10">
                                         <div data-repeater-item class="form-group row align-items-center">
                                            <div class="col-md-6">
                                               <div class="kt-form__group--inline">
                                                  <div class="kt-form__control">
                                                     <input type="text" data-name="tags[]" class="form-control" placeholder="Enter blog tag">
                                                  </div>
                                               </div>
                                            </div>

                                            <div class="col-sm-12 col-md-4 col-sm-12 col-md-4 col-lg-4">

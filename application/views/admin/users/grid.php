                       ...
                       <div class="kt-portlet__body">
                          ...
                          <div class="table-responsive dtlabel">
                             ...
                             <table class="table table-bordered table-hover table-striped icon-color export_table">
                                ...
                                <tr>
                                   <th>&nbsp;</th>
                                    ...
                                    foreach ($rows[0] as $col => $value) {
                                        ...
                                        switch ($col) {
                                         case 'full_name';
                                             echo '<th><input type="text" name="search[full_name]" value="'.$_GET['search']['full_name'].'" class="form-control" placeholder="Search..."/></th>';
                                             break;
                                         default:
                                ...
                                $s = 1;
                                foreach ($rows as $row) {
                                   if ($row->user_type == 'Developer' && _session('admin_info')->user_type != 'Developer') continue;
                                    ?>
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           if ($row->photo != '') {
                                               $photo = fancyImg_round('images/'.$module_name.'/' . $row->photo, 50, 50, $row->photo, null);
                                           } else {
                                               $photo = noImg();
                                           }
                                           switch ($col) {

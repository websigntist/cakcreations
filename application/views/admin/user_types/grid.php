...
$module = str_replace('_', ' ', 'user_types');
$module_name_full = 'user_types';
$module_name = $module;
$hide_col = ['sn'];
?>
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('User Management', $module_name.LIST_TEXT); ?>
                                ...
                                <tr>
                                   <th>&nbsp;</th>
                                    ...
                                    foreach ($rows[0] as $col => $value) {
                                       ...
                                       ?>
                                       <th><input type="text" name="<?php echo $col; ?>" value="<?php echo $_GET[$col]; ?>" class="form-control" placeholder="Search..."/></th>
                                    <?php } ?>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'id';
                                                   ...
                                                   break;
                                               case 'user_type';
                                                   echo '<td class="text-left">' . $row->user_type . '</td>';
                                                   break;
                                               case 'login';
                                                   echo '<td class="text-left">' . $row->login . '</td>';
                                                   break;
                                               default:
                                                   echo '<td>' . $value . '</td>';
                                           }

                          ...
                          <div class="table-responsive dtlabel">
                             ...
                             <table class="table table-bordered table-hover table-striped icon-color export_table">
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    ?>
                                   <tr class="<?php echo ($row->new == 1 ? 'new_order' : ''); ?>">
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'full_name';
                                                   ...
                                                   break;
                                               case 'message';
                                                   echo '<td>' . substr($row->message,0,65) . '</td>';
                                                   break;
                                               case 'datetime';
                                                   echo '<td width="180">' .date('M d, Y - H:m:s',strtotime($row->datetime)) . '</td>';
                                                   break;
                                               default:
                                                   echo '<td>' . $value . '</td>';
                                           }
                                       ...
                                       <?php } ?>
                                      <td>
                                         <a href="<?php echo base_url('admin/customer_inquiries/view_inquiry/'.$row->id); ?>" data-skin="dark" data-toggle="kt-tooltip" title="View"> <i class="la la-eye kt-font-primary"></i> </a>

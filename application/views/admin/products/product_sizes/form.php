...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
   <form action="<?php echo admin_url('product_sizes/add'); ?>" enctype="multipart/form-data" method="post" id="<? echo $module_nameFull?>">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <?php if ($row->id > 0) { ?>
                               <div class="form-group row">
                                    <label for="currency_name" class="col-sm-12 col-md-3 col-lg-3 col-form-label text-right">Enter Size: <span class="required">*</span></label>
                                    <div class="col">
                                                ...
                                                <div class="col-md-6">
                                                   <div class="kt-form__group--inline">
                                                      <div class="kt-form__control">
                                                         <input type="text" name="size" class="form-control" value="<?php echo set_value('size', $row->size); ?>">
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                          ...
                                          <div data-repeater-list="size" class="col-lg-10">
                                             <div data-repeater-item class="form-group row align-items-center">
                                                <div class="col-md-6">
                                                   <div class="kt-form__group--inline">
                                                      <div class="kt-form__control">
                                                         <input type="text" data-name="size[]" class="form-control" placeholder="Enter product size">
                                                      </div>
                                                   </div>
                                                </div>

                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'module_title';
                                                   echo '<td>' . detail_input('module_title[' . $row->id . ']', $row->id, $row->module_title, 'modules/AJAX_FULL/module_title/', 'module_title') . '</td>';
                                                   break;
                                               case 'parent';
                                                   echo '<td width="160">' . $row->parent . '</td>';
                                                   break;
                                               case 'icon';
                                                   echo '<td class="grid_icon">' . $row->icon . '</td>';
                                                   break;
                                               case 'status';

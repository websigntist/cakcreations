...
$module_name_full = 'career_cat';
$module_name = str_replace('_',' ', $module_name_full);
$hide_col = ['id', 'sn'];
?>
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('Careers', $module_name.'egories'.LIST_TEXT); ?>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title"> <?php echo $module_name.'egories'.LIST_TEXT; ?></h3>
                                </div>
                            </div>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'image';
                                                   echo '<td>' . fancyImg_round('images/'.$module_name.'/' . $row->image, 50, 50, $row->image, null) . '</td>';
                                                   break;
                                               case 'status';

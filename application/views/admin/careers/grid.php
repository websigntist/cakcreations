    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <?php echo breadcrum('Careers', $module_name.LIST_TEXT); ?>
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'image';
                                                   echo '<td>' . fancyImg_round('images/'.$module_name.'/' . $row->post_image, 50, 50, $row->image, null) . '</td>';
                                                   break;
                                               case 'industry';
                                                   echo '<td width="200" class="text-left">' . $row->industry . '</td>';
                                                   break;
                                               case 'job_title';
                                                   echo '<td width="150" class="text-left">' . $row->job_title . '</td>';
                                                   break;
                                               case 'status';

                                ...
                                <tr>
                                   <th>&nbsp;</th>
                                    ...
                                    foreach ($rows[0] as $col => $value) {
                                        ...
                                        switch ($col) {
                                          case 'title';
                                              echo '<th><input type="text" name="g_title" value="'.$_GET['g_title'].'" class="form-control" placeholder="Search..."/></th>';
                                              break;
                                          case 'ordering';
                                ...
                                <tr>
                                   <th><label class="kt-checkbox kt-checkbox--solid"><input type="checkbox" id="checkAll"><span></span></label></th>
                                    ...
                                    foreach ($rows[0] as $col => $value) {
                                        ...
                                        switch ($col) {
                                           case 'id';
                                               echo '<th width="50">' . str_replace('_', ' ',$col) . '</th>';
                                               break;
                                           default:
                                   ...
                                   <tr>
                                      <td>
                                       ...
                                       foreach ($row as $col => $value) {
                                           ...
                                           switch ($col) {
                                               case 'cover_image';
                                                   echo '<td class="ttimg">' . fancyImg('images/gallery_images/' . $row->cover_image, 60, '', $row->cover_image, null) . '<div class="timg"><span class="kt-badge kt-badge--danger""'.tooltip('total images').'">'.$row->total_images.'</span></div></td>';
                                                   break;
                                               case 'status';
                                               ...
                                               case 'created';
                                                   ...
                                                   break;
                                               case 'title';
                                                   echo '<td>' . detail_input('title',$row->id,$row->title,'galleries/AJAX/title/','title') . '</td>';
                                                   break;
                                               case 'ordering';
                                                   echo '<td>' . ordering_input($module_name.'/AJAX/ordering/',$row->id,$row->ordering) . '</td>';
                                                   break;
                                               case 'total_images';
                                                   echo '<td><span class="kt-badge kt-badge--unified-danger kt-badge--lg kt-badge--rounded kt-badge--bold">'.$row->total_images.'</span></td>';
                                                   break;
                                               default:
                                                   echo '<td>' . $value . '</td>';
                                           }
                                      ...
                                      <td width="150">
                                          ...
                                          <?php echo _upload_more_images('admin/' . $module_name . '/form/' . $row->id . '?action=more'); ?>
                                          <?php echo _view_full_gallery('admin/' . $module_name . '/full_gallery/' . $row->id); ?>
                                      </td>
                                   </tr>
                                    <?php $s++; } ?>
                                </tbody>

...
<div class="container-fluid trackidsup">
   <table>
      <tr>
         ...
         <td width="70%" class="invheading">INVOICE #: <?php echo $order->order_no; ?>
             <?php /*if (!empty($order->usps_tracking_id)){ */?><!--
            <div class="uspstracking">Tacking Id: <?php /*echo $order->usps_tracking_id; */?>
            --><?php /*} */?>
            </div>
         </td>
      </tr>
   ...
   <table class="topbox">
      <tr>
         <td width="68%">
            ...
            <p>Contact: <?php echo $user_data->phone; ?></p>
            <p>Email: <?php echo $user_data->email; ?></p>
            <p>Address: <?php echo $user_data->address2 . ', ' . $user_data->address1; ?></p>
            <p><?php echo $user_data->city . ' ' . $user_data->state  . ' ' . $user_data->zip_code . ' - ' . $user_data->country; ?></p>
         </td>
         <td width="32%">
            ...
            <p>Payment Option: <?php echo $order->payment_option; ?></p>
         </td>
      </tr>
   </table>
    <?php if (!empty($user_data->billing_address)) { ?>
       <table>
          <tr>
             <td>
                <p><b>Billing Address:</b></p>
                <p>Name: <?php echo $user_data->billing_first_name . ' ' . $user_data->billing_last_name; ?></p>
                <p>Contact: <?php echo $user_data->billing_phone; ?></p>
                <p>Email: <?php echo $user_data->billing_email; ?></p>
                <p>Address: <?php echo $user_data->billing_address; ?></p>
                <p><?php echo $user_data->billing_city . ' ' . $user_data->billing_zip_code . ' - ' . $user_data->billing_country; ?></p>
             </td>
          </tr>
       </table>
    <?php } ?>

...
if ($results): ?>
    <?php foreach ($results as $result): ?>
      <p>
         <a href="<?php echo site_url('/product/' . $result->friendly_url . '-' . $result->id); ?>"><?php echo $result->product_name . ' - ' . '$'.$result->price; ?> <span class="topSearchbtn"> <i class="fa fa-external-link"></i> View Detail</span></a>
      </p>
    <?php endforeach; ?>
<?php else: ?>

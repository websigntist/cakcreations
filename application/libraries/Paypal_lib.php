...
<script src="https://www.purchase.customerurl.com//assets/frontend/js/jquery.min.js"></script>
...
class paypal_lib
{
    ...
    function paypal_auto_form()
    {
        ...
        echo '<html>' . "\n";
        echo '<head><title>Payment Processing</title></head>' . "\n";
        echo '<body style="text-align:center;background-color: #0D0D0D" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
